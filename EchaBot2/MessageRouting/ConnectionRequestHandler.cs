    ...
    public class ConnectionRequestHandler
    {
            ...
            ChannelAccount requestorChannelAccountId, ConversationAccount requestorConversationAccountId)
        {
            ...
            if (connectionRequest != null)
            {
                ...
                if (connection is { ConversationReference1: { } })
                {
                ...
                if (doAccept)
                {
                    ...
                    {
                        var createNewDirectConversation =
                ...
                {
                    // Note: Rejecting is OK even if the sender is already connected
            ...
            MessageRouter messageRouter, MessageRouterResultHandler messageRouterResultHandler)
        {
            ...
            var connectionRequests = messageRouter.RoutingDataManager.GetConnectionRequests();
            ...
            if (connectionRequests.Count > 0)
            {
                ...
                foreach (var connectionRequestResult in connectionRequestResults)
                {
