...
namespace EchaBot2.CommandHandling
{
    ...
    public class CommandCardFactory
    {
            ...
            var card = new HeroCard
            {
                ...
                Text = string.Format(
                    ...
                    new Command(
                        ...
                        new[] { "(user ID)", "(user conversation ID)" },
                        botName).ToString()),
            ...
            ConnectionRequest connectionRequest, string botName = null)
        {
            ...
            var requestorChannelAccountName = string.IsNullOrEmpty(requestorChannelAccount.Name)
                ? StringConstants.NoUserNamePlaceholder : requestorChannelAccount.Name;
            var requestorChannelId =
            ...
            IList<ConnectionRequest> connectionRequests, bool doAccept, string botName = null)
        {
            ...
            if (!doAccept && connectionRequests.Count > 1)
            {
                card.Buttons.Add(new CardAction
                {
                    ...
                    Type = ActionTypes.ImBack,
                    Value = new Command(Commands.RejectRequest, new[] { Command.CommandParameterAll }, botName).ToString()
                });
            }
            ...
            {
                var requestorChannelAccount =
                    RoutingDataManager.GetChannelAccount(connectionRequest.Requestor, out var isBot);
                ...
                var requestorChannelId =
                    CultureInfo.CurrentCulture.TextInfo.ToTitleCase(connectionRequest.Requestor.ChannelId);
                var requestorChannelAccountId = requestorChannelAccount.Id;
